    ...
    <form method="POST" action="main.php">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                ...
                <div class="custom-control custom-checkbox custom-control-inline">
                    <input name="hobi[]" id="hobi[]_2" type="checkbox" class="custom-control-input" value="Fangirling">
                    <label for="hobi[]_2" class="custom-control-label">Fangirling</label>
                </div>
                <div class="custom-control custom-checkbox custom-control-inline">
                    <input name="hobi[]" id="hobi[]_3" type="checkbox" class="custom-control-input" value="Hiking">
                    <label for="hobi[]_3" class="custom-control-label">Hiking</label>
                </div>
            </div>
        </div>
        <div class="form-group row">
