                ...
                <tbody>
                    ...
                    @foreach ($produk as $p)
                        <tr>
                            ...
                            <td>
                                {{-- Buat tombol edit --}}
                                <a href="{{ url('produk/edit/' . $p->id) }}" class="btn btn-warning">Edit</a></td>
                                {{-- Buat tombol delete --}}
                            <td> <a href="{{ url('produk/delete/' . $p->id) }}" class="btn btn-danger" onclick="return confirm('Apakah ingin hapus produk?')">Delete</a></td>
                        </tr>
                        @php $no++; @endphp
                    @endforeach
                </tbody>
